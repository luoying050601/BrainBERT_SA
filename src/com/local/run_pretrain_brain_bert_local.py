...
from src.com.local.optimizer_local import get_lr_sched, build_optimizer
from src.com.local.save_local import ModelSaver, save_training_meta
...
from src.com.local.dataset_local import create_dataloaders
...
def main():
    ...
    args.optim = "adamw"
    args.local_rank = 0  # hvd.local_rank()
    args.n_workers = 4
    args.num_train_steps = 10000
    args.valid_steps = 500
    args.pin_mem = True
    args.grad_norm = 5.0
    args.no_cuda = False
    ...
    args.seed = random.randint(0, 4)
    print("seed = ", args.seed)

    args.do_train = True
    args.do_eval = True
    args.output_dir = Proj_dir + "/output/"
    args.do_lower_case = True
    # args.train_file = "alice.txt"
    args.on_memory = True
    args.dropout = 0.1
    ...
    args.val_datasets = [
        {
            "name": key_word,
            "text": [
                "/home/sakura/resources/BrainBertTorch/txt/"+key_word+"/pretrain_val.db"
            ],
            "brain": [
                # "/home/sakura/resources/BrainBertTorch/brain/"+key_word+"/pretrain_val.db"
            ],
            "tasks": [
                "mlm"
            ]
    ...
    args.train_datasets = [
        {
            "name": key_word,
            "text": [
                "/home/sakura/resources/BrainBertTorch/txt/"+key_word+"/pretrain_train.db",
                "/home/sakura/resources/BrainBertTorch/txt/"+key_word+"/pretrain_test.db"
            ],
            "brain": [
                 # "/home/sakura/resources/BrainBertTorch/brain/"+key_word+"/pretrain_train.db",
                 # "/home/sakura/resources/BrainBertTorch/brain/"+key_word+"/pretrain_test.db"
            ],
            "tasks": [
                "mlm"
            ],
    ...
    args.checkpoint = "/home/sakura/project/BrainBERT/output/ckpt/model_step_22.22_60000.pt"
    ...
    if args.checkpoint:
        ...
        checkpoint = {}
    model = BrainBertForPreTraining.from_pretrained(args.model_config, checkpoint, img_dim=IMG_DIM)
    ...
    # train_dataloader, all_img_dbs = create_dataloaders(
    #     datasets=args.train_datasets, text_alone=True, is_train=True, opts=args)
    # val_dataloader, _ = create_dataloaders(
    #     datasets=args.val_datasets, text_alone=True, is_train=False, opts=args, all_img_dbs=all_img_dbs)
